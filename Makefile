...
IMG_CONTROLLER ?= mcp-conductor/controller:latest
IMG_AGENT ?= mcp-conductor/agent:latest
IMG_MCP_SERVER ?= mcp-conductor/mcp-server:latest
...
run-mcp-server: manifests generate fmt vet ## Run the MCP server from your host.
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	rm Dockerfile.controller.cross Dockerfile.agent.cross
